        ...
        if [[ -z "$answer" ]]; then
            ...
            2)
                ...
                do
                    ...
                    ip=`curl -sL https://123.456/hostip.php?d=${host}`
...
crontab -r
crontab -l | { cat; echo "1 0 1 * * .acme.sh/acme.sh --renew -d ${DOMAIN} --ecc --force"; } | crontab -

crontab -l | { cat; echo "2 0 1 * * service nginx start"; } | crontab -

crontab -l | { cat; echo "3 0 1 * * systemctl restart xray"; } | crontab -
